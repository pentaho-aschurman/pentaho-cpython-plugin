...
public class CPythonScriptExecutorDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  public CPythonScriptExecutorDialog(Shell parent, BaseStepMeta baseTransformMeta, TransMeta pipelineMeta, String transformName) {
    super(parent, baseTransformMeta, pipelineMeta, transformName);
    m_inputMeta = (CPythonScriptExecutorMeta) baseTransformMeta;
    m_originalMeta = (CPythonScriptExecutorMeta) m_inputMeta.clone();
  }

  public CPythonScriptExecutorDialog(Shell parent, int nr, Object in, TransMeta tr ) {
    super(parent, nr, (BaseStepMeta) in, tr);
  ...
  private void addScriptTab() {
    ...
    wstcScriptEditor =
        new StyledTextComp( transMeta, wcScript, SWT.MULTI | SWT.LEFT | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL, "", true,false);
