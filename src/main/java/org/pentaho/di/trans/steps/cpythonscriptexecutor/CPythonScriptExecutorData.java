...
public class CPythonScriptExecutorData extends BaseStepData implements StepDataInterface {
  ...
  public static PythonSession.RowMetaAndRows determineOutputMetaSingleVariable( Object requester,
    ...
    synchronized ( requester ) {
      ...
      try {
        ...
        session = acquirePySession( requester, cPythonScriptExecutorMeta.getPythonCommand(), cPythonScriptExecutorMeta.getPytServerID(), log, vars );
        ...
        if ( !Utils.isEmpty( outAndErrors.get( 1 ) ) ) {
        ...
        releasePySession( requester, cPythonScriptExecutorMeta.getPythonCommand(), cPythonScriptExecutorMeta.getPytServerID(), vars );
      }
    }
  }
  ...
  public static void initPython( VariableSpace vars, LogChannelInterface log ) throws KettleException {
    ...
    if ( !PythonSession.pythonAvailable() ) {
      ...
      if ( !Utils.isEmpty( pyCheckResults ) ) {
        throw new KettleException(
   ...
   */
  public static void initPython( String pythonCommand, String serverID, String pyPathEntries, VariableSpace vars, LogChannelInterface log ) 
   ...
   * @throws HopException if a problem occurs
   */
  protected static void releasePySession( Object requester, String pythonCommand, String serverID, VariableSpace vars )
      throws KettleException {
    if ( pythonCommand != null ) {
      pythonCommand = vars.environmentSubstitute( pythonCommand );
    }
   ...
   * @throws HopException if a problem occurs
   */
  public static PythonSession acquirePySession( Object requester, String pythonCommand, String serverID, LogChannelInterface log, VariableSpace vars ) 
		  throws KettleException {
